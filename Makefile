...
create-labs:
	...
	cse142 lab create --name "Lab 1: The Performance Equation (Benchmark)" --short-name "intro-bench" --docker-image stevenjswanson/cse142l-swanson-runner:latest --starter-repo https://github.com/NVSL/CSE141pp-Lab-Introduction-to-the-Development-Environment.git --starter-branch tng --execution-time-limit 0:05:00 --total-time-limit 1:00:00 --due-date 2021-10-12T23:59:59
